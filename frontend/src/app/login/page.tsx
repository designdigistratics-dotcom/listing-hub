    ...
    return (
        <div className="min-h-screen flex w-full bg-white">
            ...
            <div className="w-full lg:w-1/2 flex items-center justify-center p-8 lg:p-12 xl:p-24">
                <div className="w-full max-w-[400px] space-y-10">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        {/* Forgot Password Link - Only action, right aligned usually or below */}
                        <div className="flex items-center justify-end">
                            <Link
                                href="/forgot-password"
                                className="text-sm font-medium text-slate-500 hover:text-slate-900 hover:underline transition-colors"
                            >
                                Forgot password?
                            </Link>
                        </div>
            ...
            <div className="hidden lg:block lg:w-1/2 bg-white p-4">
                ...
                {/* Optional subtle overlay if needed, usually just image for this style */}
            </div>
        </div>
    );
}
